...
public class TriplinkApiV2Test {
    ...
    public void create() throws Exception{
        ...
        request.setCardLimit(new BigDecimal(10000));
        request.setMinAuthAmount(new BigDecimal(0));
        request.setMaxAuthAmount(new BigDecimal(10000));
        ...
        request.setRequestId("2021102809240002");
    ...
    public void update() throws Exception{
        ...
        request.setCardLimit(new BigDecimal(10000));
        request.setMinAuthAmount(new BigDecimal(1000));
        request.setMaxAuthAmount(new BigDecimal(1000));
        request.setRequestId("2021102809240004");
    ...
    @Test
    public void queryAuthTranscation() throws Exception{
        QueryAuthTranscationReuqest request = new QueryAuthTranscationReuqest();
        request.setCustomerId("CSR9258286F29A84");
        request.setCardLogId("f06afb9c2615e10f399eeba6b8f2476e54bd3c5d988be6f68d041dc2d1280e44");
        QueryAuthTranscationResponse response = tripLinkApi.queryAuthTranscation(request);
        Assert.assertNotNull(response);
    }

    @Test
    public void querySettlementTranscation() throws Exception{
        QuerySettlementTranscationRequest request = new QuerySettlementTranscationRequest();
        request.setCustomerId("CSR9258286F29A84");
        request.setCardLogId("399d1322867b6774b4144ba968149d50d33201c0c8082785df8b780beeb79f81");
        QuerySettlementTranscationResponse response = tripLinkApi.querySettlementTranscation(request);
        Assert.assertNotNull(response);
    }
