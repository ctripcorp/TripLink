...
public class TripLinkBizImpl implements TripLinkBiz {
    ...
    public OperateResponse operate(OperateRequest request) {
        ...
        CallHttpResponse httpResponse = httpClient.post(requestJson,url+OPERATE_METHOD,null);
        logger.info("call tripLink operate responseStr is："+httpResponse);
        OperateResponse response = JacksonUtil.str2Object(httpResponse.getResult(),OperateResponse.class);
        //卡信息解密
    ...
    public QOperateResultResponse qOperateResult(QOperateResultRequest request) {
        ...
        CallHttpResponse httpResponse = httpClient.post(requestJson,url+OPERATE_RESULT_METHOD,null);
        logger.info("call tripLink qOperateResult responseStr is："+httpResponse);
        QOperateResultResponse response = JacksonUtil.str2Object(httpResponse.getResult(),QOperateResultResponse.class);
        //卡信息解密
        decryptCardInfo(response.getCardInfo(),desKey);
        return response;
    }
    ...
    public QInfoResponse qInfo(QInfoRequest request) {
        ...
        CallHttpResponse httpResponse = httpClient.post(requestJson,url+QINFO_METHOD,null);
        logger.info("call tripLink qInfo responseStr is："+httpResponse);
        QInfoResponse response = JacksonUtil.str2Object(httpResponse.getResult(), QInfoResponse.class);
        //卡信息解密
        decryptCardInfo(response.getCardInfo(),desKey);
        return response;
    }
    ...
    public QTransInfoResponse qTransInfo(QTransInfoRequest request) {
        ...
        CallHttpResponse httpResponse = httpClient.post(requestJson,url+TRANS_METHOD,null);
        logger.info("call tripLink qTransInfo responseStr is："+httpResponse);
        return JacksonUtil.str2Object(httpResponse.getResult(), QTransInfoResponse.class);
    }
    ...
    private static String buildOperateSignData(OperateRequest request) {
        ...
        if (null != request.getCardInfo()) {
            ...
            if (null != request.getCardInfo().getWillChangeAmt()) {
                stringBuffer.append(String.valueOf(request.getCardInfo().getWillChangeAmt()));
            }
