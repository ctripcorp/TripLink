...
require_once(__DIR__ . '/../src/triplink/vcc/card/client/query/QueryCreateResultRequest.php');
require_once(__DIR__ . '/../src/triplink/vcc/card/client/query/QueryCreateResultResponse.php');
...
class CardUpdateTest extends TestCase
{
    ...
    public function test()
    {
        ...
        $queryCardRequest = new QueryCreateResultRequest();
        ...
        $cardOperation->queryCreateCardResult($queryCardRequest);
    }
