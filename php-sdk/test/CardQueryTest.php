...
class CardQueryTest extends TestCase
{
    ...
    public function test()
    {
        ...
        $queryCardRequest = new QueryCardInfoRequest();
        $queryCardRequest->setRequestId("card20210728224700002");
        $queryCardRequest->setRequestTime("20210728230850");
        $queryCardRequest->setMerchantName("WANWEI");
        $queryCardRequest->setChannelType("WANWEI_CFNC_VCC");
        $queryCardRequest->setCardLogId("a7558f115f25893d3588d9fc3ecab8e8b887bc92e82f4c3e2ba3d4e239a6e9b9");
        $queryCardRequest->setOperator("max");
        $cardOperation = new CardOperation($URL, $PRIVATE_KEY, $RSA_KEY);
        $cardOperation->queryCardInfoResult($queryCardRequest);
    }
