...
class QueryAuthorizationResponse extends BaseResponse implements JsonSerializable {
    /**
     * 卡ID
    ...
    /**
     * 授权交易
     * @var Authorization[]|null authorization transactions
     */
    private $list = null;
    ...
    public static function fromArray(array $array): self {
        ...
        $instance->list = isset($array['list']) ? array_map([Authorization::class, 'fromArray'], $array['list']) : null;
        return $instance;
    }
