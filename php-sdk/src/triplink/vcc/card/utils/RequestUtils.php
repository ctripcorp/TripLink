...
require_once(__DIR__ . '/../client/operate/CreateCardInfo.php');
require_once(__DIR__ . '/../client/operate/UpdateCardInfo.php');
require_once(__DIR__ . '/../client/CardInfo.php');
require_once(__DIR__ . '/../client/query/QueryCreateResultRequest.php');
require_once(__DIR__ . '/../client/query/QueryOperateRequest.php');

require_once(__DIR__ . '/../client/query/QueryCreateResultResponse.php');
require_once(__DIR__ . '/../client/query/QueryInfoRequest.php');
require_once(__DIR__ . '/../client/query/QueryTransInfoRequest.php');
